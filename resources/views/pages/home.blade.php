    ...
    <section id="hero" class="hero section">
        <div class="hero-slider swiper init-swiper">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide thlin-hero-slide thlin-hero-slide--blue"></div>
                <div class="swiper-slide thlin-hero-slide thlin-hero-slide--green"></div>
                <div class="swiper-slide thlin-hero-slide thlin-hero-slide--orange"></div>
            </div>
